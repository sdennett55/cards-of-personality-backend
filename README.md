...
2. Add the URL to your github repo to the `repository` field in `app.json`, then:
    1. Push the repo to github
    2. Deploy to Heroku with this link using your github repo URL: https://heroku.com/deploy?template=URL_TO_YOUR_BACKEND_GITHUB_REPO/tree/master
...
6. Add the URL to your new heroku backend to `netlify.toml` and `src/config.js`, then: 
    1. Push the repo to github
    2. Deploy to Netlify with this link using your github repo URL: https://app.netlify.com/start/deploy?repository=URL_TO_YOUR_FRONTEND_GITHUB_REPO
...
9. (Optional) Make your own decks and/or modify existing ones via the `/create-deck` and `/edit-deck/example-deck` frontends.
